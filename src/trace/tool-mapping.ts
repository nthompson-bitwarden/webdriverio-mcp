...
const TOOL_MAP: Record<string, TraceAction> = {
  ...
  mock_electron_api: { class: 'Electron', method: 'mock' },
  get_electron_mock_calls: { class: 'Electron', method: 'mockCalls' },
  manage_electron_mock: { class: 'Electron', method: 'manageMock' },
